  ...
  return (
    <>
        ...
        <div className='fourth'>
            <div>
                <img src="https://rtcamp.com/wp-content/uploads/sites/2/2021/06/Google-Web-Stories-Embed-rtCamp-Featured-Image.png?w=1920&quality=100&strip=all" alt=" "/>
            </div>
            <div className='fourth-page-second-part'>
                ...
                <a href="https://rtcamp.com/case-studies/building-embedded-web-stories-for-wordpress/">View Case Study</a>
            </div>
        </div>

        <div className='fourth'id='fourth-page'>
            <div>
                <img src="https://rtcamp.com/wp-content/uploads/sites/2/2021/05/migrating-dealertrack-from-aem-to-wordpress-case-study.png?w=1200&quality=100&strip=all" alt=" "/>
            </div>
            <div className='fourth-page-second-part'>
                ...
                <a href="https://rtcamp.com/case-studies/dealertrack-aem-wordpress-migration/">View Case Study</a>
            </div>
        </div>
